...
fm['area/recruitment']:is_older(15):is_unseen():delete_messages()
fm['area/tech']:is_older(60):delete_messages()
fm['area/woodworking']:is_older(60):delete_messages()
fm['area/woodworking']:contain_from('pinterest.com'):is_older(15):delete_messages()
